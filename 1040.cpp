...
In case of exam, read one more score.
 ...
 Recalculate the average (sum the exam score with the previous calculated average and divide by 2) and
 print the message “Aluno aprovado.” (Approved student) in case of average 5.0 or more) or "Aluno reprovado." (Reproved student) in case of average 4.9 or less.
...
int main() {
    ...
    if (avg >= 5.0 && avg <= 6.9) {
        ...
        avg = (avg + N5) / 2;
        if (avg >= 5.0) cout << "Aluno aprovado.\n";
